...
class FilesOrganierGUI(ctk.CTk):
    def __init__(self):
        ...
        self.iconbitmap(r"C:\Users\HP\Downloads\favicon.ico")
        
        # images
        play = Image.open(r"C:\Users\HP\OneDrive\الصور\play.png")
        self.play = ctk.CTkImage(light_image = play)
        options = Image.open(r"C:\Users\HP\OneDrive\الصور\justified.png")
        self.options = ctk.CTkImage(light_image=options, size=(45,45))
        questions = Image.open(r"C:\Users\HP\OneDrive\الصور\qa.png")
        self.questions = ctk.CTkImage(light_image=questions, size=(45,45))
        close = Image.open(r"C:\Users\HP\OneDrive\الصور\cross.png")
        self.close = ctk.CTkImage(dark_image=close,size=(27,27))

        self.dark_theme = Image.open(r"C:\Users\HP\OneDrive\الصور\dark_theme.jpg")
        self.blue_theme = Image.open(r"C:\Users\HP\OneDrive\الصور\blue_background.jpg")
        
        insta = Image.open(r"C:\Users\HP\OneDrive\الصور\SocialMedia\instagram.png")
        self.insta = ctk.CTkImage(dark_image=insta,size=(38,38))
        tiktok = Image.open(r"C:\Users\HP\OneDrive\الصور\SocialMedia\tik-tok.png")
        self.tiktok = ctk.CTkImage(dark_image=tiktok,size=(40,40))
        youtube = Image.open(r"C:\Users\HP\OneDrive\الصور\SocialMedia\youtube.png")
        self.youtube = ctk.CTkImage(dark_image=youtube,size=(40,40))
        github = Image.open(r"C:\Users\HP\OneDrive\الصور\SocialMedia\github.png")
        self.github = ctk.CTkImage(dark_image=github,size=(40,40))
        linkedin = Image.open(r"C:\Users\HP\OneDrive\الصور\SocialMedia\linkedin.png")
    ...
    def create_pages(self):
        ...
        # Frames
        self.middle_frame = tk.Canvas(self.pages["welcome"],bd=0,background='#010730',
                                          highlightthickness=0,relief='ridge')
        self.top_frame = ctk.CTkFrame(self.pages["welcome"],corner_radius=0,
                                        bg_color='#010730',fg_color='#010730')
        ...
        self.insta_button = ctk.CTkButton(self.top_frame,0,0,image=self.insta,fg_color='#010730',
                                          text='',command=lambda: self.open_link(self.insta_button))
        self.tiktok_button = ctk.CTkButton(self.top_frame,0,0,image=self.tiktok,fg_color='#010730',
                                          text='',command=lambda: self.open_link(self.tiktok_button))
        self.youtube_button = ctk.CTkButton(self.top_frame,0,0,image=self.youtube,fg_color='#010730',
                                          text='',command=lambda: self.open_link(self.youtube_button))
        self.github_button = ctk.CTkButton(self.top_frame,0,0,image=self.github,fg_color='#010730',
                                          text='',command=lambda: self.open_link(self.github_button))
        self.linkedin_button = ctk.CTkButton(self.top_frame,0,0,image=self.linkedin,fg_color='#010730',
